...
p1=createSprite(displayWidth-450,displayHeight-600,20,20)
p1.addImage(p1_img)
p1.scale=0.5

p2=createSprite(displayWidth-450,displayHeight-300,20,20)
p2.addImage(p2_img)
p2.scale=0.5

p3=createSprite(displayWidth-920,displayHeight-580,20,20)
p3.addImage(p3_img)
p3.scale=0.5

p4=createSprite(displayWidth-920,displayHeight-300,20,20)
p4.addImage(p4_img)
p4.scale=0.5

p6=createSprite(displayWidth-920,displayHeight-450,20,20)
p6.addImage(p1_img)
p6.scale=0.5

p7=createSprite(displayWidth-700,displayHeight-600,20,20)
p7.addImage(p2_img)
p7.scale=0.5
